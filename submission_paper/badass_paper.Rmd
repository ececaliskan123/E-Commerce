...
(Felix) I want to propose another document style, which would be written in LaTeX. I have written my bachelor thesis with the classicthesis theme and prefer its clean look over the barebones Rmd look. It's just looks but that counts with the people reading it, too.
Unfortunately the Rmd PDF generation is hardly customizeable.
Let's discuss this on Jan 10.
